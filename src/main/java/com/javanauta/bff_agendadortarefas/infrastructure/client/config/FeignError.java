...
import com.javanauta.bff_agendadortarefas.infrastructure.exceptions.BusinessException;
...
public class FeignError implements ErrorDecoder {
    ...
    private String mensagemErro(Response response) {
        try {
            ...
            return new String(response.body().asInputStream().readAllBytes(), StandardCharsets.UTF_8);// transformar o body em string de errro
        } catch (IOException e) {
